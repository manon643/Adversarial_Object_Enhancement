...
python36 prepare_dataset/prepare_small.py --images_dir ../VOC2012/JPEGImages/val --output_dir ../VOC2012/VerySmallImages/val
python36 prepare_dataset/prepare_small.py --images_dir ../VOC2012/JPEGImages/train --output_dir ../VOC2012/VerySmallImages/train
